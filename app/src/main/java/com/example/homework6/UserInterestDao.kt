...
import com.example.homework6.data.entities.UserInterestEntity
...
interface UserInterestDao {
    ...
    suspend fun insertEmptyInterest(interest: UserInterestEntity): Long
    ...
    suspend fun incrementWeight(userId: Int, topicId: Int, delta: Int) {
        ...
        val result = insertEmptyInterest(UserInterestEntity(userId, topicId, 0.0))
