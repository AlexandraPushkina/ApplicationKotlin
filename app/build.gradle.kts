...
android {
    ...
    buildFeatures {
        compose = true
        viewBinding = true  //вместо неудобного findViewById()
    }
...
dependencies {
    ...
    implementation(libs.material)  //Официальная библиотека для UI
    implementation(libs.androidx.constraintlayout)  //constraintlayout - Компоновщик интерфейсов,
